...
class _MedicalReportsScreenState extends State<MedicalReportsScreen>
                    ...
                    children: [
                      ...
                      Obx(() => PopupMenuButton<String>(
                            ...
                            itemBuilder: (BuildContext context) => [
                              ...
                              PopupMenuItem(
                                  value: 'week', child: Text('Last Week')),
                              PopupMenuItem(
                                  value: 'month', child: Text('Last Month')),
                              PopupMenuItem(
                                  value: 'year', child: Text('Last Year')),
                            ],
                            child: Container(
  ...
  Widget _buildTrendsTab() {
    return Obx(() {
      ...
      return SingleChildScrollView(
        ...
        child: Column(
          children: [
            for (final type in vitalTypes.whereType<String>()) ...[
              VitalTrendChart(
  ...
  Widget _buildDocumentsTab() {
    return Obx(() {
      ...
      if (controller.uploadedReports.isEmpty &&
          controller.medicalDocuments.isEmpty) {
        return Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
        ...
        child: ListView(
          ...
          children: [
            ...
            if (controller.uploadedReports.isNotEmpty) ...[
              ...
              SizedBox(height: 12),
              ...controller.uploadedReports
                  .map((report) => _buildUploadedReportCard(report)),
              SizedBox(height: 24),
            ],
  ...
  Widget _buildUploadedReportCard(UploadedMedicalReport report) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
            color: isProcessed ? Colors.green : Colors.orange, width: 2),
      ),
      child: Padding(
        padding: EdgeInsets.all(16),
        child: Column(
            ...
            if (isProcessed) ...[
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 4),
                  Text("$biomarkersCount biomarkers",
                      style: TextStyle(fontSize: 12)),
                  SizedBox(width: 12),
                  Icon(Icons.medication, size: 14, color: Colors.green),
                  SizedBox(width: 4),
                  Text("$recommendationsCount recommendations",
                      style: TextStyle(fontSize: 12)),
                ],
              ),
            ] else ...[
              ...
              children: [
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed:
                        hasFileUrl ? () => _viewReport(report.fileUrl!) : null,
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(
                          color:
                              hasFileUrl ? Colors.blue : Colors.grey.shade300),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(
                          color:
                              hasFileUrl ? Colors.green : Colors.grey.shade300),
                      padding: EdgeInsets.symmetric(vertical: 10),
                    ),
                  ),
                ),
