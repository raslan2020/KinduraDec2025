...
#ifndef KINDURAWATCH_SWIFT_H
#define KINDURAWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KinduraWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class HKSampleType;
SWIFT_CLASS("_TtC12KinduraWatch13HealthManager")
@interface HealthManager : NSObject <HKLiveWorkoutBuilderDelegate, HKWorkoutSessionDelegate, WCSessionDelegate>
