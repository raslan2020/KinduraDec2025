class CourseList {
  ...
  CourseList({this.status, this.result});
...
class Result {
  ...
  List<NextSchedules>? nextSchedules;

  Result({this.course, this.medicines, this.schedules, this.nextSchedules});
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    if (json['next_schedules'] != null) {
      nextSchedules = <NextSchedules>[];
      json['next_schedules'].forEach((v) {
        nextSchedules!.add(new NextSchedules.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.nextSchedules != null) {
      data['next_schedules'] =
          this.nextSchedules!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class NextSchedules {
  ...
  NextSchedules.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    medicineId = json['medicine_id'];
    medicineName = json['medicine_name'];
    medicineDescription = json['medicine_description'];
